...
3. Commit: short, plain message, no fluff/bullets. Match repo's existing style if one exists.
4. Push, then `gh pr create`.
5. Title/body: casual, human, 1-2 sentences on what+why. No headers, no "## Summary"/"## Test plan" scaffolding unless the repo expects it.
